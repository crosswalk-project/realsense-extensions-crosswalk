function LeftRender(sp) {
  var renderer = document.getElementById('imageRender');
  ...
  function init() {
    ...
    document.getElementById('leftContainer').insertBefore(sampleFps.domElement, renderer);
    // Add the mouse event handler to toggle color and depth image.
    renderer.onclick = toggleView;
  }
