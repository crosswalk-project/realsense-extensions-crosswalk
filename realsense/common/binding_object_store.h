...
#ifndef SRC_REALSENSE_COMMON_BINDING_OBJECT_STORE_H_
#define SRC_REALSENSE_COMMON_BINDING_OBJECT_STORE_H_
...
#endif  // SRC_REALSENSE_COMMON_BINDING_OBJECT_STORE_H_
