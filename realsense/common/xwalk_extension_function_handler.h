...
#ifndef SRC_REALSENSE_COMMON_XWALK_EXTENSION_FUNCTION_HANDLER_H_
#define SRC_REALSENSE_COMMON_XWALK_EXTENSION_FUNCTION_HANDLER_H_
...
class XWalkExtensionFunctionHandler {
 public:
  ...
  explicit XWalkExtensionFunctionHandler(Instance* instance);
...
#endif  // SRC_REALSENSE_COMMON_XWALK_EXTENSION_FUNCTION_HANDLER_H_
